...
![]({{ site.url }}{{ site.baseurl }}/images/respic/asdcnv.png){: style="width: 33%; float: left;margin-right: 30px; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/genediscovery.png){: style="width: 33%; float: left;margin-right: 30px; border: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/scn2a.jpg){: style="width: 33%; float: left;margin-right: 30px; border: 10px"}
